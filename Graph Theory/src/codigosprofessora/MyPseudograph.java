...
public class MyPseudograph {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("\nGrau (d_G) e Vizinhos (N_G) de cada v�rtice:");
	    ...
	    while (it.hasNext()) {
	    	...
	    	while (it2.hasNext()) {
	    		N = N + " " + ((it2.next()).getNeighbour(v)).toString();
	    	}
	    ...
	    System.out.println("Grafo � direcionado? " + graphgml.isDirected());
	    System.out.println("Grafo � ponderado? " + graphgml.isWeighted());
