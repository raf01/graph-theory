...
public class MySimpleGraph {
	...
	public static void main(String[] args) {
		...
		// Vizinhos NG(v)
		System.out.println("\nArestas que possuem o v�rtices PE como Terminal: " + g.edgesOf("PE"));
		
		// Ciclos Simples B�sicos
		PatonCycleBase <String,DefaultEdge> c = new PatonCycleBase <> (g);
		System.out.println("\nCiclos B�sicos do grafo: " + c.findCycleBase());
		
		
		// Comparando Arestas
	    DefaultEdge e1 = g.getEdge("CE","PI");
	    DefaultEdge e2 = g.getEdge("PI","CE");
	    System.out.println("\nA ordem de v�rtices na aresta n�o importa: " + e1.equals(e2));
